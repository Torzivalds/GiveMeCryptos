<?php
session_start();
if (!empty($_POST['nom']) && !empty($_POST['adresseBCH']) && !empty($_POST['sujet']) && !empty($_POST['message']) && !empty($_POST['mail'])) {
	$nom = htmlspecialchars($_POST['nom']);
	$mail = htmlspecialchars($_POST['mail']);
	$adresseBCH = htmlspecialchars($_POST['adresseBCH']);
	...
	$message_txt = "Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Bitcoin Cash : " . $adresseBCH . "<br>Message : " . $message;
	$message_html = "<html><head></head><body>Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Bitcoin Cash : " . $adresseBCH . "<br>Message : " . $message . "</body></html>";
	//==========
	...
	//=====Définition du sujet.
	$sujet = "Nouveau message envoyé via Give Me Bitcoin Cash !";
	//=========
						...
						<div class="col-md-8 col-md-offset-2 text-center ubea-heading">
							...
							<p>
								<form action="contact.php" method="post">
									...
									Votre adresse Bitcoin Cash : <br><input type="text" name="adresseBCH" required size="40" <?php if(!empty($_SESSION['adresseBCH'])){echo $_SESSION['adresseBCH'];} ?>><br>
