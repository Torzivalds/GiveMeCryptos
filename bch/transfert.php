...
if (empty($_SESSION['adresseBCH'])) {
	...
	if (!empty($_GET['val']) && htmlspecialchars($_GET['val']) == 'oui') {
		...
		$message_txt = "Adresse BCH : " . $_SESSION['adresseBCH'];
		$message_html = "<html><head></head><body>Adresse BCH : " . $_SESSION['adresseBCH'] . "</body></html>";
		//==========
		...
		//=====Définition du sujet.
		$sujet = "Demande de transfert de fonds sur Give Me Bitcoin Cash.";
		//=========
		 
		//=====Création du header de l'e-mail.
		$header = "From: \"Anonyme\"<anonyme@givemeBitcoin Cash.fr>".$passage_ligne;
		$header.= "Reply-to: \"Anonyme\" <anonyme@givemeBitcoin Cash.fr>".$passage_ligne;
...
<html>
	...
	<title>Demander à transfèrer les fonds - Give me Bitcoin Cash</title>
	</head>
	<body>
