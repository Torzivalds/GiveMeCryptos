<?php
session_start();
if (!empty($_POST['nom']) && !empty($_POST['adresseXRP']) && !empty($_POST['sujet']) && !empty($_POST['message']) && !empty($_POST['mail'])) {
	$nom = htmlspecialchars($_POST['nom']);
	$mail = htmlspecialchars($_POST['mail']);
	$adresseXRP = htmlspecialchars($_POST['adresseXRP']);
	...
	$message_txt = "Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Ripple : " . $adresseXRP . "<br>Message : " . $message;
	$message_html = "<html><head></head><body>Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Ripple : " . $adresseXRP . "<br>Message : " . $message . "</body></html>";
	//==========
	...
	//=====Définition du sujet.
	$sujet = "Nouveau message envoyé via Give Me Ripple !";
	//=========
						...
						<div class="col-md-8 col-md-offset-2 text-center ubea-heading">
							...
							<p>
								<form action="contact.php" method="post">
									...
									Votre adresse Ripple : <br><input type="text" name="adresseXRP" required size="40" <?php if(!empty($_SESSION['adresseXRP'])){echo $_SESSION['adresseXRP'];} ?>><br>
