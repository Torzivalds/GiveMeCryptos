<?php
session_start();
if (!empty($_POST['nom']) && !empty($_POST['adresseLTC']) && !empty($_POST['sujet']) && !empty($_POST['message']) && !empty($_POST['mail'])) {
	$nom = htmlspecialchars($_POST['nom']);
	$mail = htmlspecialchars($_POST['mail']);
	$adresseLTC = htmlspecialchars($_POST['adresseLTC']);
	...
	$message_txt = "Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Litecoin : " . $adresseLTC . "<br>Message : " . $message;
	$message_html = "<html><head></head><body>Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Litecoin : " . $adresseLTC . "<br>Message : " . $message . "</body></html>";
	//==========
	...
	//=====Définition du sujet.
	$sujet = "Nouveau message envoyé via Give Me Litecoin !";
	//=========
						...
						<div class="col-md-8 col-md-offset-2 text-center ubea-heading">
							...
							<p>
								<form action="contact.php" method="post">
									...
									Votre adresse Litecoin : <br><input type="text" name="adresseLTC" required size="40" <?php if(!empty($_SESSION['adresseLTC'])){echo $_SESSION['adresseLTC'];} ?>><br>
