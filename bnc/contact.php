<?php
session_start();
if (!empty($_POST['nom']) && !empty($_POST['adresseBNC']) && !empty($_POST['sujet']) && !empty($_POST['message']) && !empty($_POST['mail'])) {
	$nom = htmlspecialchars($_POST['nom']);
	$mail = htmlspecialchars($_POST['mail']);
	$adresseBNC = htmlspecialchars($_POST['adresseBNC']);
	...
	$message_txt = "Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Bytecoin : " . $adresseBNC . "<br>Message : " . $message;
	$message_html = "<html><head></head><body>Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Bytecoin : " . $adresseBNC . "<br>Message : " . $message . "</body></html>";
	//==========
	...
	//=====Définition du sujet.
	$sujet = "Nouveau message envoyé via Give Me Bytecoin !";
	//=========
						...
						<div class="col-md-8 col-md-offset-2 text-center ubea-heading">
							...
							<p>
								<form action="contact.php" method="post">
									...
									Votre adresse Bytecoin : <br><input type="text" name="adresseBNC" required size="40" <?php if(!empty($_SESSION['adresseBNC'])){echo $_SESSION['adresseBNC'];} ?>><br>
