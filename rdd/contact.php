<?php
session_start();
if (!empty($_POST['nom']) && !empty($_POST['adresseRDD']) && !empty($_POST['sujet']) && !empty($_POST['message']) && !empty($_POST['mail'])) {
	$nom = htmlspecialchars($_POST['nom']);
	$mail = htmlspecialchars($_POST['mail']);
	$adresseRDD = htmlspecialchars($_POST['adresseRDD']);
	...
	$message_txt = "Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Reddcoin : " . $adresseRDD . "<br>Message : " . $message;
	$message_html = "<html><head></head><body>Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Reddcoin : " . $adresseRDD . "<br>Message : " . $message . "</body></html>";
	//==========
	...
	//=====Définition du sujet.
	$sujet = "Nouveau message envoyé via Give Me Reddcoin !";
	//=========
						...
						<div class="col-md-8 col-md-offset-2 text-center ubea-heading">
							...
							<p>
								<form action="contact.php" method="post">
									...
									Votre adresse Reddcoin : <br><input type="text" name="adresseRDD" required size="40" <?php if(!empty($_SESSION['adresseRDD'])){echo $_SESSION['adresseRDD'];} ?>><br>
