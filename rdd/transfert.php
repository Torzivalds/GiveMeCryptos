...
if (empty($_SESSION['adresseRDD'])) {
	...
	if (!empty($_GET['val']) && htmlspecialchars($_GET['val']) == 'oui') {
		...
		$message_txt = "Adresse RDD : " . $_SESSION['adresseRDD'];
		$message_html = "<html><head></head><body>Adresse RDD : " . $_SESSION['adresseRDD'] . "</body></html>";
		//==========
		...
		//=====Définition du sujet.
		$sujet = "Demande de transfert de fonds sur Give Me Reddcoin.";
		//=========
...
<html>
	...
	<title>Demander à transfèrer les fonds - Give me Reddcoin</title>
	</head>
	<body>
