<?php
session_start();
if (!empty($_POST['nom']) && !empty($_POST['adresseZEC']) && !empty($_POST['sujet']) && !empty($_POST['message']) && !empty($_POST['mail'])) {
	$nom = htmlspecialchars($_POST['nom']);
	$mail = htmlspecialchars($_POST['mail']);
	$adresseZEC = htmlspecialchars($_POST['adresseZEC']);
	...
	$message_txt = "Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Zcash : " . $adresseZEC . "<br>Message : " . $message;
	$message_html = "<html><head></head><body>Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Zcash : " . $adresseZEC . "<br>Message : " . $message . "</body></html>";
	//==========
	...
	//=====Définition du sujet.
	$sujet = "Nouveau message envoyé via Give Me Zcash !";
	//=========
						...
						<div class="col-md-8 col-md-offset-2 text-center ubea-heading">
							...
							<p>
								<form action="contact.php" method="post">
									...
									Votre adresse Zcash : <br><input type="text" name="adresseZEC" required size="40" <?php if(!empty($_SESSION['adresseZEC'])){echo $_SESSION['adresseZEC'];} ?>><br>
