...
if (empty($_SESSION['adresseEMC'])) {
	...
	if (!empty($_GET['val']) && htmlspecialchars($_GET['val']) == 'oui') {
		...
		$message_txt = "Adresse EMC : " . $_SESSION['adresseEMC'];
		$message_html = "<html><head></head><body>Adresse EMC : " . $_SESSION['adresseEMC'] . "</body></html>";
		//==========
		...
		//=====Définition du sujet.
		$sujet = "Demande de transfert de fonds sur Give Me Monero.";
		//=========
...
<html>
	...
	<title>Demander à transfèrer les fonds - Give me Monero</title>
	</head>
	<body>
	...
	<div class="ubea-section-overflow" style="text-align: center; ">
		<p>
			Adresse du porte feuille Monero :<br><input type="text" name="adresseEMC" value="<?php echo htmlspecialchars($_SESSION['adresseEMC']); ?>" size="50"><br>
