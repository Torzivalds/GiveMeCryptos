<?php
session_start();
if (!empty($_POST['nom']) && !empty($_POST['adresseEMC']) && !empty($_POST['sujet']) && !empty($_POST['message']) && !empty($_POST['mail'])) {
	$nom = htmlspecialchars($_POST['nom']);
	$mail = htmlspecialchars($_POST['mail']);
	$adresseEMC = htmlspecialchars($_POST['adresseEMC']);
	...
	$message_txt = "Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Emercoin : " . $adresseEMC . "<br>Message : " . $message;
	$message_html = "<html><head></head><body>Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Emercoin : " . $adresseEMC . "<br>Message : " . $message . "</body></html>";
	//==========
	...
	//=====Définition du sujet.
	$sujet = "Nouveau message envoyé via Give Me Emercoin !";
	//=========
						...
						<div class="col-md-8 col-md-offset-2 text-center ubea-heading">
							...
							<p>
								<form action="contact.php" method="post">
									...
									Votre adresse Emercoin : <br><input type="text" name="adresseEMC" required size="40" <?php if(!empty($_SESSION['adresseEMC'])){echo $_SESSION['adresseEMC'];} ?>><br>
