<?php
session_start();
if (!empty($_POST['nom']) && !empty($_POST['adresseBLK']) && !empty($_POST['sujet']) && !empty($_POST['message']) && !empty($_POST['mail'])) {
	$nom = htmlspecialchars($_POST['nom']);
	$mail = htmlspecialchars($_POST['mail']);
	$adresseBLK = htmlspecialchars($_POST['adresseBLK']);
	...
	$message_txt = "Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Blackcoin : " . $adresseBLK . "<br>Message : " . $message;
	$message_html = "<html><head></head><body>Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Blackcoin : " . $adresseBLK . "<br>Message : " . $message . "</body></html>";
	//==========
	...
	//=====Définition du sujet.
	$sujet = "Nouveau message envoyé via Give Me Blackcoin !";
	//=========
						...
						<div class="col-md-8 col-md-offset-2 text-center ubea-heading">
							...
							<p>
								<form action="contact.php" method="post">
									...
									Votre adresse Blackcoin : <br><input type="text" name="adresseBLK" required size="40" <?php if(!empty($_SESSION['adresseBLK'])){echo $_SESSION['adresseBLK'];} ?>><br>
