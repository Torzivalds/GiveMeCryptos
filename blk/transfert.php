...
if (empty($_SESSION['adresseBLK'])) {
	...
	if (!empty($_GET['val']) && htmlspecialchars($_GET['val']) == 'oui') {
		...
		$message_txt = "Adresse BLK : " . $_SESSION['adresseBLK'];
		$message_html = "<html><head></head><body>Adresse BLK : " . $_SESSION['adresseBLK'] . "</body></html>";
		//==========
		...
		//=====Définition du sujet.
		$sujet = "Demande de transfert de fonds sur Give Me Blackcoin.";
		//=========
		 
		//=====Création du header de l'e-mail.
		$header = "From: \"Anonyme\"<anonyme@givemeBlackcoin.fr>".$passage_ligne;
		$header.= "Reply-to: \"Anonyme\" <anonyme@givemeBlackcoin.fr>".$passage_ligne;
...
<html>
	...
	<title>Demander à transfèrer les fonds - Give me Blackcoin</title>
	</head>
	<body>
