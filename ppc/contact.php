...
if (!empty($_POST['nom']) && !empty($_POST['adresseXMR']) && !empty($_POST['sujet']) && !empty($_POST['message']) && !empty($_POST['mail'])) {
	...
	$message_txt = "Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Peercoin : " . $adresseXMR . "<br>Message : " . $message;
	$message_html = "<html><head></head><body>Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Peercoin : " . $adresseXMR . "<br>Message : " . $message . "</body></html>";
	//==========
	...
	//=====Définition du sujet.
	$sujet = "Nouveau message envoyé via Give Me Peercoin !";
	//=========
						...
						<div class="col-md-8 col-md-offset-2 text-center ubea-heading">
							...
							<p>
								<form action="contact.php" method="post">
									...
									Votre adresse Peercoin : <br><input type="text" name="adresseXMR" required size="40" <?php if(!empty($_SESSION['adresseXMR'])){echo $_SESSION['adresseXMR'];} ?>><br>
