...
if (!empty($_POST['nom']) && !empty($_POST['sujet']) && !empty($_POST['message']) && !empty($_POST['mail'])) {
	...
	$mail = 'rudy.barnaud@gmail.com'; // Déclaration de l'adresse de destination.
	...
	$message_txt = "Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Message : " . $message;
	$message_html = "<html><head></head><body>Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Message : " . $message . "</body></html>";
	//==========
	...
	//=====Définition du sujet.
	$sujet = "Nouveau message envoyé via Give Me Crypto !";
	//=========
