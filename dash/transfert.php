...
if (empty($_SESSION['adresseDASH'])) {
	...
	if (!empty($_GET['val']) && htmlspecialchars($_GET['val']) == 'oui') {
		...
		$message_txt = "Adresse DASH : " . $_SESSION['adresseDASH'];
		$message_html = "<html><head></head><body>Adresse DASH : " . $_SESSION['adresseDASH'] . "</body></html>";
		//==========
		...
		//=====Définition du sujet.
		$sujet = "Demande de transfert de fonds sur Give Me Dash.";
		//=========
		 
		//=====Création du header de l'e-mail.
		$header = "From: \"Anonyme\"<anonyme@givemeDash.fr>".$passage_ligne;
		$header.= "Reply-to: \"Anonyme\" <anonyme@givemeDash.fr>".$passage_ligne;
...
<html>
	...
	<title>Demander à transfèrer les fonds - Give me Dash</title>
	</head>
	<body>
