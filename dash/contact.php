<?php
session_start();
if (!empty($_POST['nom']) && !empty($_POST['adresseDASH']) && !empty($_POST['sujet']) && !empty($_POST['message']) && !empty($_POST['mail'])) {
	$nom = htmlspecialchars($_POST['nom']);
	$mail = htmlspecialchars($_POST['mail']);
	$adresseDASH = htmlspecialchars($_POST['adresseDASH']);
	...
	$message_txt = "Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Dash : " . $adresseDASH . "<br>Message : " . $message;
	$message_html = "<html><head></head><body>Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Dash : " . $adresseDASH . "<br>Message : " . $message . "</body></html>";
	//==========
	...
	//=====Définition du sujet.
	$sujet = "Nouveau message envoyé via Give Me Dash !";
	//=========
						...
						<div class="col-md-8 col-md-offset-2 text-center ubea-heading">
							...
							<p>
								<form action="contact.php" method="post">
									...
									Votre adresse Dash : <br><input type="text" name="adresseDASH" required size="40" <?php if(!empty($_SESSION['adresseDASH'])){echo $_SESSION['adresseDASH'];} ?>><br>
