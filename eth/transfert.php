...
if (empty($_SESSION['adresseETH'])) {
	...
	if (!empty($_GET['val']) && htmlspecialchars($_GET['val']) == 'oui') {
		...
		$message_txt = "Adresse ETH : " . $_SESSION['adresseETH'];
		$message_html = "<html><head></head><body>Adresse ETH : " . $_SESSION['adresseETH'] . "</body></html>";
		//==========
		...
		//=====Définition du sujet.
		$sujet = "Demande de transfert de fonds sur Give Me Ethereum.";
		//=========
		 
		//=====Création du header de l'e-mail.
		$header = "From: \"Anonyme\"<anonyme@givemeEthereum.fr>".$passage_ligne;
		$header.= "Reply-to: \"Anonyme\" <anonyme@givemeEthereum.fr>".$passage_ligne;
...
<html>
	...
	<title>Demander à transfèrer les fonds - Give me Ethereum</title>
	</head>
	<body>
