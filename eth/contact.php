<?php
session_start();
if (!empty($_POST['nom']) && !empty($_POST['adressedETH']) && !empty($_POST['sujet']) && !empty($_POST['message']) && !empty($_POST['mail'])) {
	$nom = htmlspecialchars($_POST['nom']);
	$mail = htmlspecialchars($_POST['mail']);
	$adressedETH = htmlspecialchars($_POST['adressedETH']);
	...
	$message_txt = "Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Ethereum : " . $adressedETH . "<br>Message : " . $message;
	$message_html = "<html><head></head><body>Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Ethereum : " . $adressedETH . "<br>Message : " . $message . "</body></html>";
	//==========
	...
	//=====Définition du sujet.
	$sujet = "Nouveau message envoyé via Give Me Ethereum !";
	//=========
						...
						<div class="col-md-8 col-md-offset-2 text-center ubea-heading">
							...
							<p>
								<form action="contact.php" method="post">
									...
									Votre adresse Ethereum : <br><input type="text" name="adressedETH" required size="40" <?php if(!empty($_SESSION['adressedETH'])){echo $_SESSION['adressedETH'];} ?>><br>
