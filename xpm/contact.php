<?php
session_start();
if (!empty($_POST['nom']) && !empty($_POST['adresseXPM']) && !empty($_POST['sujet']) && !empty($_POST['message']) && !empty($_POST['mail'])) {
	$nom = htmlspecialchars($_POST['nom']);
	$mail = htmlspecialchars($_POST['mail']);
	$adresseXPM = htmlspecialchars($_POST['adresseXPM']);
	...
	$message_txt = "Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Primecoin : " . $adresseXPM . "<br>Message : " . $message;
	$message_html = "<html><head></head><body>Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Primecoin : " . $adresseXPM . "<br>Message : " . $message . "</body></html>";
	//==========
	...
	//=====Définition du sujet.
	$sujet = "Nouveau message envoyé via Give Me Primecoin !";
	//=========
						...
						<div class="col-md-8 col-md-offset-2 text-center ubea-heading">
							...
							<p>
								<form action="contact.php" method="post">
									...
									Votre adresse Primecoin : <br><input type="text" name="adresseXPM" required size="40" <?php if(!empty($_SESSION['adresseXPM'])){echo $_SESSION['adresseXPM'];} ?>><br>
