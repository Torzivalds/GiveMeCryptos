...
if (empty($_SESSION['adresseXPM'])) {
	...
	if (!empty($_GET['val']) && htmlspecialchars($_GET['val']) == 'oui') {
		...
		$message_txt = "Adresse XPM : " . $_SESSION['adresseXPM'];
		$message_html = "<html><head></head><body>Adresse XPM : " . $_SESSION['adresseXPM'] . "</body></html>";
		//==========
		...
		//=====Définition du sujet.
		$sujet = "Demande de transfert de fonds sur Give Me Primecoin.";
		//=========
		 
		//=====Création du header de l'e-mail.
		$header = "From: \"Anonyme\"<anonyme@givemePrimecoin.fr>".$passage_ligne;
		$header.= "Reply-to: \"Anonyme\" <anonyme@givemePrimecoin.fr>".$passage_ligne;
...
<html>
	...
	<title>Demander à transfèrer les fonds - Give me Primecoin</title>
	</head>
	<body>
