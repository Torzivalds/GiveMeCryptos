<?php
session_start();
if (!empty($_POST['nom']) && !empty($_POST['adresseBTC']) && !empty($_POST['sujet']) && !empty($_POST['message']) && !empty($_POST['mail'])) {
	$nom = htmlspecialchars($_POST['nom']);
	$mail = htmlspecialchars($_POST['mail']);
	$adresseBTC = htmlspecialchars($_POST['adresseBTC']);
	...
	$message_txt = "Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Bitcoin : " . $adresseBTC . "<br>Message : " . $message;
	$message_html = "<html><head></head><body>Sujet : " . $sujet . "<br>Nom : " . $nom . "<br>Adresse Bitcoin : " . $adresseBTC . "<br>Message : " . $message . "</body></html>";
	//==========
	...
	//=====Définition du sujet.
	$sujet = "Nouveau message envoyé via Give Me Bitcoin !";
	//=========
						...
						<div class="col-md-8 col-md-offset-2 text-center ubea-heading">
							...
							<p>
								<form action="contact.php" method="post">
									...
									Votre adresse Bitcoin : <br><input type="text" name="adresseBTC" required size="40" <?php if(!empty($_SESSION['adresseBTC'])){echo $_SESSION['adresseBTC'];} ?>><br>
